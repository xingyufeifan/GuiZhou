...
public class BNMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bnman);
...
//        }).start();
    ...
    private void routeplanToNavi(CoordinateType coType) {
        ...
        switch (coType) {
            case GCJ02: {
                sNode = new BNRoutePlanNode(106.3023, 29.3647, "财富大厦", null, coType);
                eNode = new BNRoutePlanNode(106.39750, 29.90882, "北京天安门", null, coType);
                break;
            }
            case WGS84: {
    ...
    public class DemoRoutePlanListener implements RoutePlanListener {
        ...
        public void onJumpToNavigator() {
            ...
            System.out.println("传输的什么："+bundle);
